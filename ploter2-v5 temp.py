...
fig1.suptitle('Max Hoop Stress evolution in concrete')
axs2=axs1.twinx()

#fig2, axs2 = plt.subplots()
#fig2.suptitle('Pullout Curve')
fig3, axs3 = plt.subplots()
fig3.suptitle('Max Tensile Stress In Yarn')

for index in [1,2,3]:

    # assign path of monitor.csv 
    Monitor_dir_path = "C:/Users/adelpasand/Desktop/PS3/axi-Diss controlled with softening in Ktt- 1mm 150 step C {} .gid/AtenaCalculation/monitors.csv".format(index)  
    # assign path of inp file (.inp )
    Inp_dir_path = "C:/Users/adelpasand/Desktop/PS3/axi-Diss controlled with softening in Ktt- 1mm 150 step C {} .gid/AtenaCalculation/axi-Diss controlled with softening in Ktt- 1mm 150 step try2.inp".format(index)   
    ...
    axs1.set(xlabel='Displacement load (mm)', ylabel='Max Hoop stress (Mpa)')
    axs1.plot(Diss_load*1000, sigma_tt , label='C={} MPa'.format(index)) 
    ...
    axs2.set(xlabel='Displacement load (mm)', ylabel='Reaction (N)')
    axs2.plot(Diss_load*1000, -Yarn_M_S*1000000, linestyle='dashed')
    ...
    axs3.set(xlabel='Displacement load (mm)', ylabel='Stress (MPa)')
    axs3.plot(Diss_load*1000, Yarn_M_S , label='C={} MPa'.format(index))
    ...
    X_extraticks=[xmax]
    Y_extraticks=[ymax]
    secax_x = axs3.secondary_xaxis('top')
    secax_x.set_xticks(X_extraticks)
    secax_y = axs3.secondary_yaxis('right')
    secax_y.set_yticks(Y_extraticks)
