...
def interface_parameters_changer(current_inp_path, output_dir, new_inp_name, K_NN ,K_TT,C_0,phi,FT_0,eitc=1,rdc={}, soft_hard_fun=[]):
    ...
    if 'TYPE "CC2DInterface"' in Material_db:
        ...
        with open(bat_path, 'w') as f:
            ...
            print("in the defined output directory, inp file and bat file of the model '% s' are created" % new_inp_name)
    else:
        print('No CC2DInterface material found in the inp file')

def run_inps(output_dir, model):
