...
Monitor_dir_path = "C:/Users/adelpasand/Desktop/models/axi-Diss controlled with softening in Ktt- 1mm 150 step C 1 .gid/AtenaCalculation/monitors.csv"  
# assign path of inp file (.inp )
Inp_dir_path = "C:/Users/adelpasand/Desktop/models/axi-Diss controlled with softening in Ktt- 1mm 150 step C 1 .gid/AtenaCalculation/axi-Diss controlled with softening in Ktt- 1mm 150 step try2.inp"  
...
fig, axs = plt.subplots()
fig.suptitle('Pullout Curve')
axs.set(xlabel='Load Steps', ylabel='Reaction (N)')
